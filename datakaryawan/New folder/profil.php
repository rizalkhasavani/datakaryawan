...
?>
	<div class="container">
		<div class="content">
			...
			<?php
			$nama = $_GET['nama']; // mengambil data nik dari nik yang terpilih
			
			$sql = mysqli_query($koneksi, "SELECT * FROM karyawan WHERE nama='$nama'"); // query memilih entri nik pada database
