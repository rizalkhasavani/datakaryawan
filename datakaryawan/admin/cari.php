...
?>
	<div class="container">
		<div class="content">
			...
			if(isset($_GET['nik']) == 'delete'){ // jika tombol 'Hapus Data' pada baris 74 ditekan
			...
			<a href="profile.php?aksi=delete&nik=<?php echo $row['nik']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Anda yakin akan mengahapus data <?php echo $row['nik']; ?>')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Hapus Data</a>
		</div> <!-- /.content -->
	</div> <!-- /.container -->
<?php 
